...
fn main() {
    ...
    //world
    let small_sphere = Sphere::new([0.0, 0.0, -1.0], 0.5).into();
    let big_sphere = Sphere::new([0.0, -100.5, -1.0], 100.0).into();
    let world = HittableList::from(vec![small_sphere, big_sphere]);
